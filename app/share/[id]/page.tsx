...
export default async function SharePage({ params }: SharePageProps) {
  ...
  return (
    <main className="relative flex min-h-[calc(100vh-218px)] items-center justify-center px-4 pb-8 pt-2 sm:px-6 lg:px-8">
      <section className="flex w-full max-w-4xl justify-center py-6">
        <div
          style={style}
        ...
        >
          ...
          <div className="relative grid gap-5 p-5 sm:p-6 lg:grid-cols-[1.08fr_0.92fr] lg:items-stretch">
            <div className="flex min-h-[280px] flex-col justify-between rounded-md border border-white/14 bg-black/18 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] sm:p-6">
              ...
              <div className="py-7 sm:py-8">
                <div className="text-[4.75rem] font-black leading-none text-white drop-shadow-[0_7px_0_rgba(0,0,0,0.24)] sm:text-[6.25rem]">
                  {userScore}
            ...
            <div className="grid gap-3">
              <div className="rounded-md border border-white/18 bg-white/[0.08] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)]">
                ...
                <div className="mt-2 text-2xl font-black leading-tight text-white">{userTeam.season} {userTeam.franchise}</div>
              ...
              <div className="rounded-md border border-white/20 bg-black/34 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]">
                ...
                <div className="mt-2 text-3xl font-black leading-tight text-white">{result.mvp.name}</div>
