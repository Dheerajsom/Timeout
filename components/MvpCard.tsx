...
export function MvpCard({ mvp, averaged = false }: { mvp: PlayerBoxScore; averaged?: boolean }) {
  ...
  return (
    <div className="relative flex min-h-[330px] min-w-0 flex-1 overflow-hidden rounded-md border border-amber-200/34 bg-[#100c14] p-4 shadow-[0_24px_60px_rgba(32,16,9,0.4),inset_0_1px_0_rgba(255,255,255,0.12)] sm:rounded-[1.45rem] sm:p-5">
      ...
      <div className="relative flex w-full min-w-0 flex-col justify-between gap-5">
        <div>
